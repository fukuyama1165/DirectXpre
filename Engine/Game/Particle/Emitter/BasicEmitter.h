...
public:
	...
	void Initialize(const Vector3& pos, std::string particleType, const float& liveTime = 10, const float& actionMaxTime=10, const float& ActiveTime = -1, const Vector2& randRengeX = { -1,1 }, const Vector2& randRengeY = { -1,1 }, const Vector2& randRengeZ = { -1,1 }, std::string particleModel = "whiteBox", std::string emitterModel = "whiteBox")override;
